import logo from '@/images/clients/we-lab/logo-dark.png'
import imageHero from './hero.jpg'
import imageEmilySelman from './emily-selman.jpg'

export const caseStudy = {
  client: 'Welab',
  title: 'Rapid Agile DevOps for Fintech Innovation',
  domain: 'Fintech',
  description:
    'We refactored core business logic, developed new features, and enhanced code quality while improving the code review process, enabling WeLab to accelerate innovation with a more efficient and agile development workflow.',
  summary: [
