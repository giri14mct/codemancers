import logo from '@/images/clients/flipkart/logo-dark.svg'
...
export const caseStudy = {
  client: 'Flipkart',
  domain: 'Ecommerce',
  title: 'Ensuring a Seamless Shopping Experience During Peak Seasons',
  description:
    'We collaborated with Flipkart to understand the requirements for their website and worked closely with their in-house development team to ensure timely delivery, meeting critical deadlines for a seamless shopping experience.',
  summary: [
