import logo from '@/images/clients/mid-trans/logo-dark.png'
...
export const caseStudy = {
  client: 'Midtrans',
  domain: 'Fintech',
  title: 'Scaling Engineering Culture and Best Practices',
  description:
    'We identified and resolved challenges within development teams that were impacting productivity and eroding confidence in shipping features to production. Our mentorship focused on best practices in both programming and development workflows, empowering teams to deliver with efficiency and reliability.',
  summary: [
