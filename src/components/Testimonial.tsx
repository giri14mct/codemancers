...
export function Testimonial({ heading = false }: TestimonialProps) {
  const testimonials = [
    {
  ...
  return (
    <>
      <div
        className={`relative isolate mt-24 bg-neutral-50 py-16 ${
          heading ? '' : 'sm:mt-32 sm:py-28 md:py-32 lg:mt-40'
        }`}
      >
        <GridPattern
